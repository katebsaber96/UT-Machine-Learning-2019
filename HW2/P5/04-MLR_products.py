...
# Importing the data
df_Xtrain = pd.read_csv("./data/Xtrain_products.csv")
df_Xtest = pd.read_csv("./data/Xtest_products.csv")
...
# column_space = list(df_Xtrain.columns)[1:]
# column_space = combinations(column_space,2)
# # print(list(column_space))
# for col in column_space:
#     df_Xtrain[col[0]+col[1]] = df_Xtrain[col[0]] * df_Xtrain[col[1]]
#     df_Xtest[col[0] + col[1]] = df_Xtest[col[0]] * df_Xtest[col[1]]
#     print(col[0], col[1])
#
# df_Xtrain.to_csv('./data/Xtrain_products.csv')
# df_Xtest.to_csv('./data/Xtest_products.csv')
...
# plt.show()
plt.savefig('./plots/actual_predicted_difference_products.png')
